...
class Helpers {
  ...
  public getAllowedAndDefaultRoles() {
    return {
      allowedRoles: [
        Locals.config().hasuraGraphqlUserRole,
        Locals.config().hasuraGraphqlListenerRole,
        Locals.config().hasuraGraphqlHostRole,
        Locals.config().hasuraGraphqlSpeakerRole,
      ],
      defaultRole: Locals.config().hasuraGraphqlListenerRole,
    };
  }
