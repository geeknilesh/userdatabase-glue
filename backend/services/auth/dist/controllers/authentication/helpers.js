...
class Helpers {
    ...
    getAllowedAndDefaultRoles() {
        return {
            allowedRoles: [
                locals_1.default.config().hasuraGraphqlUserRole,
                locals_1.default.config().hasuraGraphqlListenerRole,
                locals_1.default.config().hasuraGraphqlHostRole,
                locals_1.default.config().hasuraGraphqlSpeakerRole,
            ],
            defaultRole: locals_1.default.config().hasuraGraphqlListenerRole,
        };
    }
    /**
     * Password Generator
