    ...
    static handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { data: datas, errors: errorss } = yield commons_1.default.GQLRequest({
                    variables: {
                        role: defaultUserRole,
                        user_id: data.data.insert_users_one.id,
                    },
                    query: mutations_1.default.InsertUserRole,
                });
                ...
                return commons_1.default.Response(res, true, "Signup successfully!", Object.assign(Object.assign(Object.assign({}, data.data.insert_users_one), datas.data.insert_user_role_one), token));
            }
            catch (error) {
