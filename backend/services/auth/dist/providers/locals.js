...
class Locals {
    ...
    static config() {
        ...
        //custom roles
        const hasuraGraphqlListenerRole = process.env.HASURA_GRAPHQL_LISTENER_ROLE || "";
        const hasuraGraphqlHostRole = process.env.HASURA_GRAPHQL_HOST_ROLE || "";
        const hasuraGraphqlSpeakerRole = process.env.HASURA_GRAPHQL_SPEAKER_ROLE || "";
        //end custom roles
        ...
        return {
            ...
            hasuraGraphqlListenerRole,
            hasuraGraphqlHostRole,
            hasuraGraphqlSpeakerRole,
            hasuraGraphqlURL,
            //
            jwtSecret,
            jwtKey,
